...
Das Logo trägt im Normalfall noch die Abkürzung \emph{e.V.}. Sie wird hochgestellt hinter dem \emph{eSport} platziert und ist je nach Hintergrund schwarz oder weiß, entsprechend der regulären Schriftfarbe. %schriftart?
